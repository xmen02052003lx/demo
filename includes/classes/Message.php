...
class Message {
    ...
    public function getMessages($otherUser) {
        ...
        while($row = mysqli_fetch_array($get_messages_query)) {
            ...
            $div_top = ($user_to == $userLoggedIn) ? "<div class='message' id='white'>" : "<div class='message' id='green'>";
    ...
    public function getConvo() {
        ...
        foreach($convos as $username) {
            ...
            // echo $username;
            // echo $user_found_obj->getFirstAndLastName();
            // echo $user_found_obj->getProfilePic();
            if($username != "") {
            ...
            <span class='timestamp_smaller' id='grey'>" . $latest_message_details[2] . "</span> <p id='grey' style='margin:0;'>" . $latest_message_details[0] . $split . "</p> </div> </a>
            ";
        }}
